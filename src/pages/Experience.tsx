...
const experiences = [
  ...
  { startDate: "May 2025", endDate: "Present", title: "Head of Software Engineering", logo: "/logos/cogbiasAI.png", description: "At CogBiasAI, I work under the CTO to lead product development, overseeing the system architecture, roadmap, and team execution. I am currently leading cross-functional teams across the backend, frontend, and internal AI API integration. I architected the full system from the ground up, designed scalable infrastructure, wrote user stories, and defined sprints; I serve as Scrum Master to ensure timely delivery. I also created and am maintaining the product roadmap, acting as both Product Manager and Owner.", isActive: true},
